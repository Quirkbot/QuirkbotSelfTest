Quirkbot firmware upload in production (v1.0.1)
============
...
---
#### 03 - Clone or download this repository
...
Enter the directory and issue a "NPM install".
```
$ cd QuirkbotSelfTest
$ npm install
```
---
#### 05 - Make note of the Quirkbots COM port
...
---
#### 07 - Verify for SUCCESS or FAILED
